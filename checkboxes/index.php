<?php
/*
Plugin Name: checkbox
Plugin URI: https://checkbox.com/
Description: 
Version: 4.1.7
Author: Automattic 
...
function smashing_add_post_meta_boxes() {
    ...
    add_meta_box(
      ...
      esc_html__( 'ISI Functions', 'checkbox' ),    // Title
...
function smashing_post_class_meta_box( $post ) { ?>
    ...
    <p>
        <label for="smashing-post-class"><?php _e( "Add a custom CSS class, which will be applied to WordPress' post class.", 'checkbox' ); ?></label>
        <br />
